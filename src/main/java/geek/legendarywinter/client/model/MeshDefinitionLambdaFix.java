package geek.legendarywinter.client.model;
 ...
 * @author diesieben07
 */
public interface MeshDefinitionLambdaFix extends ItemMeshDefinition {

	ModelResourceLocation getLocation(ItemStack stack);

	// Helper method to easily create lambda instances of this class
	static ItemMeshDefinition create(MeshDefinitionLambdaFix lambda) {
		return lambda;
	}
